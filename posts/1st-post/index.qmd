...
description: "This post is heavily inspired by Marcus Pivato's notes on measure and probability. This post is still in progress."
author:
  - name: "Alex Yuan"
...
If one remembers back to the first examples of $\sigma$-algebras, the power set $\mathcal{P}(\Omega)$ represents a state of total omniscience, while $\{\emptyset,\Omega}$ represents a state of total ignorance.
