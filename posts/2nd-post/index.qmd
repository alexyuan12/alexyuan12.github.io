...
Let $\{X_0, X_1,\ldots, X_n\}$ be a markov chain and $S$ be a state space. If we are interested in the probability of making it from state $i$ to state $j$ over $T$ steps, then the $T$-step probabilities are given by 
$$
